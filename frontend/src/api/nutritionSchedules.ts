...
export const nutritionSchedulesApi = {
  ...
  create: (data: { pet_id: string; name: string; active?: boolean; notify?: boolean; rules?: unknown }) =>
    api.post<NutritionSchedule>('/nutrition/schedules', data),
  update: (id: string, data: { name?: string; active?: boolean; notify?: boolean; rules?: unknown }) =>
